...
/**
 * Anybodyマッチメイキング - ギャザリングに参加しているユーザID一覧取得リクエスト。
 * 
 * @author Game Server Services, Inc.
 *
 */
@SuppressWarnings("serial")
public class AnybodyDescribeJoinedUserRequest extends Gs2UserRequest<AnybodyDescribeJoinedUserRequest> {
	 ...
	 * @return this
	 */
	public AnybodyDescribeJoinedUserRequest withMatchmakingName(String matchmakingName) {
	 ...
	 * @return this
	 */
	public AnybodyDescribeJoinedUserRequest withGatheringId(String gatheringId) {

...
/**
 * Roomマッチメイキング - ギャザリングからの離脱リクエスト。
 * 
 * @author Game Server Services, Inc.
 *
 */
@SuppressWarnings("serial")
public class RoomLeaveGatheringRequest extends Gs2UserRequest<RoomLeaveGatheringRequest> {
	 ...
	 * @return this
	 */
	public RoomLeaveGatheringRequest withMatchmakingName(String matchmakingName) {
	 ...
	 * @return this
	 */
	public RoomLeaveGatheringRequest withGatheringId(String gatheringId) {

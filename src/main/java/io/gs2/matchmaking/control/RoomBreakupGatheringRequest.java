...
public class RoomBreakupGatheringRequest extends Gs2UserRequest<RoomBreakupGatheringRequest> {
	 ...
	 * @return this
	 */
	public RoomBreakupGatheringRequest withMatchmakingName(String matchmakingName) {
	 ...
	 * @return this
	 */
	public RoomBreakupGatheringRequest withGatheringId(String gatheringId) {

...
/**
 * Anybodyマッチメイキング - ギャザリングからの離脱リクエスト。
 * 
 * @author Game Server Services, Inc.
 *
 */
@SuppressWarnings("serial")
public class AnybodyLeaveGatheringRequest extends Gs2UserRequest<AnybodyLeaveGatheringRequest> {
	 ...
	 * @return this
	 */
	public AnybodyLeaveGatheringRequest withMatchmakingName(String matchmakingName) {
	 ...
	 * @return this
	 */
	public AnybodyLeaveGatheringRequest withGatheringId(String gatheringId) {

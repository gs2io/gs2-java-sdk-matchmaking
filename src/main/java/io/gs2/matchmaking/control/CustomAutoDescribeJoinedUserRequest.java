...
/**
 * CustomAutoマッチメイキング - ギャザリングに参加しているユーザID一覧取得リクエスト。
 * 
 * @author Game Server Services, Inc.
 *
 */
@SuppressWarnings("serial")
public class CustomAutoDescribeJoinedUserRequest extends Gs2UserRequest<CustomAutoDescribeJoinedUserRequest> {
	 ...
	 * @return this
	 */
	public CustomAutoDescribeJoinedUserRequest withMatchmakingName(String matchmakingName) {
	 ...
	 * @return this
	 */
	public CustomAutoDescribeJoinedUserRequest withGatheringId(String gatheringId) {

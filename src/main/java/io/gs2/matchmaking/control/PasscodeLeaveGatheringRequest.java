...
/**
 * Passcodeマッチメイキング - ギャザリングからの離脱リクエスト。
 * 
 * @author Game Server Services, Inc.
 *
 */
@SuppressWarnings("serial")
public class PasscodeLeaveGatheringRequest extends Gs2UserRequest<PasscodeLeaveGatheringRequest> {
	 ...
	 * @return this
	 */
	public PasscodeLeaveGatheringRequest withMatchmakingName(String matchmakingName) {
	 ...
	 * @return this
	 */
	public PasscodeLeaveGatheringRequest withGatheringId(String gatheringId) {

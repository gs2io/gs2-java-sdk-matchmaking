...
/**
 * Passcodeマッチメイキング - ギャザリングの早期終了リクエスト。
 * 
 * @author Game Server Services, Inc.
 *
 */
@SuppressWarnings("serial")
public class PasscodeEarlyCompleteGatheringRequest extends Gs2UserRequest<PasscodeEarlyCompleteGatheringRequest> {
	 ...
	 * @return this
	 */
	public PasscodeEarlyCompleteGatheringRequest withMatchmakingName(String matchmakingName) {
	 ...
	 * @return this
	 */
	public PasscodeEarlyCompleteGatheringRequest withGatheringId(String gatheringId) {
